...
namespace InputEvents
{
    ...
    public class CreatePlayer : SubscriptionData
    {
        public delegate void SubscripionDelegate(InputEventInfo _inputEventInfo);
        private static SubscripionDelegate[] channelSubscriptions = new SubscripionDelegate[] {  delegate { }, delegate { } }; //for channel-specific Subscriptions
        private static SubscripionDelegate subscriptions = delegate { }; //for all other subscriptions (that don't care about channel)
    ...
    public class MeleeAttack : SubscriptionData
    {
        public delegate void SubscripionDelegate(InputEventInfo _inputEventInfo);
        private static SubscripionDelegate[] channelSubscriptions = new SubscripionDelegate[] {  delegate { }, delegate { } }; //for channel-specific Subscriptions
        private static SubscripionDelegate subscriptions = delegate { }; //for all other subscriptions (that don't care about channel)
    ...
    public class MenuBack : SubscriptionData
    {
        public delegate void SubscripionDelegate(InputEventInfo _inputEventInfo);
    ...
    public class MenuConfirm : SubscriptionData
    {
        public delegate void SubscripionDelegate(InputEventInfo _inputEventInfo);
        private static SubscripionDelegate[] channelSubscriptions = new SubscripionDelegate[] {  delegate { }, delegate { }, delegate { }, delegate { } }; //for channel-specific Subscriptions
        private static SubscripionDelegate subscriptions = delegate { }; //for all other subscriptions (that don't care about channel)
    ...
    public class MovementAbility : SubscriptionData
    {
        public delegate void SubscripionDelegate(InputEventInfo _inputEventInfo);
        private static SubscripionDelegate[] channelSubscriptions = new SubscripionDelegate[] {  delegate { }, delegate { } }; //for channel-specific Subscriptions
        private static SubscripionDelegate subscriptions = delegate { }; //for all other subscriptions (that don't care about channel)
    ...
    public class RangedAttack : SubscriptionData
    {
        public delegate void SubscripionDelegate(InputEventInfo _inputEventInfo);
        private static SubscripionDelegate[] channelSubscriptions = new SubscripionDelegate[] {  delegate { }, delegate { } }; //for channel-specific Subscriptions
        private static SubscripionDelegate subscriptions = delegate { }; //for all other subscriptions (that don't care about channel)
