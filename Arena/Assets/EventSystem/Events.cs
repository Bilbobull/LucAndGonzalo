namespace Events
{
    ...
    {
        public delegate void SubscripionDelegate(float gameDuration, System.Collections.Generic.List<int> roundNumber);
        ...
        /// Requires a function which takes: float gameDuration, System.Collections.Generic.List<int> roundNumber
        /// </summary>
        ...
        /// </summary>
        /// <param name="_eventFunction"></param>
        public static void Send(float gameDuration, System.Collections.Generic.List<int> roundNumber)
        {
            subscriptions.Invoke(gameDuration, roundNumber);
        }
    }
    ...
    {
        public delegate void SubscripionDelegate(int Test);
        private static SubscripionDelegate subscriptions = delegate{ };

        /// <summary>
        /// Subscribes to this event so that when the event is sent the supplied function is called.
        /// Requires a function which takes: int Test
        /// </summary>
        /// <param name="_eventFunction"></param>
        public static void Subscribe(SubscripionDelegate _eventFunction)
        {
        ...
        /// </summary>
        /// <param name="_eventFunction"></param>
        public static void Send(int Test)
        {
            subscriptions.Invoke(Test);
        }
    }
}
