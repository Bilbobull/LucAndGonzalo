...
#define MyAppName "Arenathon"
#define MyAppVersion "1.0"
#define MyAppPublisher "DigiPen Institute of Technology"
#define MyAppURL "http://www.digipen.edu/"
#define MyAppExeName "Arenathon.exe"
#define MyIconName "Arenathon_Icon.ico"
...
AppId={{24F4B946-5081-4613-8B65-D5EC61369562}       
AppName={#MyAppName}
...
[Icons]
IconFilename: "{app}\Arenathon_Icon.ico"; Name: "{group}\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; 
IconFilename: "{app}\Arenathon_Icon.ico"; Name: "{group}\{cm:UninstallProgram,{#MyAppName}}"; Filename: "{uninstallexe}"; 
IconFilename: "{app}\Arenathon_Icon.ico"; Name: "{commondesktop}\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; Tasks: desktopicon; 
IconFilename: "{app}\Arenathon_Icon.ico"; Name: "{userappdata}\Microsoft\Internet Explorer\Quick Launch\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; Tasks: quicklaunchicon; 
